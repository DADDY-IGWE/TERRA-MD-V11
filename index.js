...
console.log("CONNECTING TERRA_MD-V1👨🏽‍🍼...");
...
console.log('TERRA_MD-V1 CONNECTED TO WHATSAPP ✅')

let up = `*╭──────────────●●►*
> *𝘛𝘦𝘳𝘳𝘢 𝘔𝘥 𝘤𝘰𝘯𝘯𝘦𝘤𝘵𝘦𝘥 𝘴𝘶𝘤𝘤𝘦𝘴𝘴𝘧𝘶𝘭𝘭𝘺✨ 𝘵𝘺𝘱𝘦 .𝘮𝘦𝘯𝘶 𝘵𝘰 𝘴𝘩𝘰𝘸 𝘢𝘭𝘭 𝘤𝘰𝘯𝘮𝘢𝘯𝘥⚡️*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs❁*

*https://whatsapp.com/channel/0029Vb0BMSV0lwggTbQs1c3M*


*╭⊱✫⚡️TERRA-MD V1⚡️✫⊱╮*
*│ - 🔰REPOSITORY:* *TERRA-MD-V1*
*│ - 📃DESCRIPTION:* *THE WORLD BEST WHATSAPP BOT♻️*
*│ - 👨🏽‍🍼DEV:* *CRAZY DEV⚡️*
*│ - 🔅URL:* *https://github.com/LORD-IGWE/TERRA-MD-V1*

*YOUR BOT ACTIVE NOW ENJOY♥️🪄*\n\n*PREFIX: ${prefix}*

*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: `https://i.imgur.com/2xefaSu.jpeg` }, caption: up })
...
if(senderNumber.includes("24102027877")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("GUY⚡️, TERRA-MD-V1 STARTED ✅");
});
